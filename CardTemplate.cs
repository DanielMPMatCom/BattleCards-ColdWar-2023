...
public class CardTemplate
{
    ...
    public string cardtype { get; set; }           // Unidad;  politica
...
public class Unit : CardTemplate
{
    public Unit(string CardName, string cardtype, string Rareness, string Lore, int Health, int Attack, string political_current, string PathToPhoto, string EffectText, List<Token> Effect) : base(CardName, cardtype, Rareness, Lore, Health, Attack, political_current, PathToPhoto, EffectText, Effect)
    {

    }
}

public class Politic : CardTemplate
{
    public Politic(string CardName, string cardtype, string Rareness, string Lore, int Health, int Attack, string political_current, string PathToPhoto, string EffectText, List<Token> Effect) : base(CardName, cardtype, Rareness, Lore, Health, Attack, political_current, PathToPhoto, EffectText, Effect)
    {
